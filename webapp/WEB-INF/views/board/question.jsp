	   ...
	   td:nth-of-type(5) { width:67px; text-align:center;  }
    	...
    	function insertBoard(){
    		...
    		$.ajax({
    			url : '/InsertQuestion',
    			type : 'POST',
    			data : {cont: cont, member_num: member_num},
    			success : function(){
    				alert('성공');
    				getMemberQuestionList();
    			},
    	...
    	// 고객이 문의한 내용 리스트 가져오기 
    	function getMemberQuestionList(){
    		var member_num = ${login.member_num};
    		$.ajax({
					...
					<div class="card">
						...
						<div class="card-footer">
							<div class="input-group">
								...
								<input type="text" id="cont" name="cont" class="form-control type_msg" onkeyup="enterKey();"placeholder="문의할 내용을 입력하세요."/>
								<div class="input-group-append">
