...
<head>
  ...
  <script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
	<script>
		...
		// 주문 목록에서 체크된 목록 삭제 
		function orderList(){
			var outCountList = new Array();
			$('input[type=checkbox]:checked').each(function(){
				outCountList.push($(this).val());
			});
			
			alert(outCountList);
			$.ajax({
				url : '/OutCountBasketDelete',
				type : 'POST',
				data : {outCountList: outCountList},
				success : function(){
					alert('삭제완료!');
					location.href = "/OutCountPage";
				},
				error : function(){
					alert('실패');
				}
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h1 class="my-4">출고 목록 </h1>

      </div>
      <!-- /.col-lg-3 -->

      <div class="col-lg-9">
		<c:forEach var="list" items="${outCountlist}">
        <div class="row1">
          <div class="col-lg-4 col-md-6 mb-4">
			...
			<div class="orderbar">
         		<input type="submit" id="order" onclick="javascript:outCountEnd();"value="출고하기"/>
