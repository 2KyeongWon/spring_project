                                    ...
                                    <div class="card-body">
                                        <form action="/MEMBERUPDATEPASSWORD" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" name="member_pwd" type="password" placeholder="비밀번호를 입력하세요" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword">비밀번호 확인</label>
