    ...
    <head>
     ...
     function addRow() {
		...
		//Cell 에 텍스트 추가
		 ...
		 newCell7.innerHTML = '<input type="text" id="remarks" name="remarks"/>';
     } // addRow() end
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form id="boardForm" name="boardForm">
                                    ...
                                    <input type="submit" onclick="javascript:stockInsert();" value="확인"/>
                                    <input type="submit" onclick="javascript:stockDelete();" value="삭제" />
                                    <input type="button" id="StockUpdate" value="수정" />
                                </div>
                            </div>
                        </div>
                    </div>
